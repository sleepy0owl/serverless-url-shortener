...
class UrlShortnerStack extends cdk.Stack {
  ...
  constructor(scope, id, props) {
    ...
    const table = new dynamodb.Table(this, 'sm-url-shortner-map', {
      partitionKey: { name: 'id', type: dynamodb.AttributeType.STRING}
    });

    const fn = new lambda.Function(this, 'sm-url-shortner-function', {
    ...
    const api = new apigw.LambdaRestApi(this, 'sm-url-shortner', {
      handler: fn,
      proxy: false
    });
